...
public class SecurityConfig {
    ...
    private final String[] PUBLIC_ENDPOINTS = {"/api/v1/auth/*", "/login", "/error", "/login-with-google", "/api/v1/videos/filter", "/api/v1/videos/watch/*", "/api/v1/search/*", "/api/v1/videos/*/related","/api/v1/videos/view-event"};
