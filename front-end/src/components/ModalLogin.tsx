...
export default function ModalLogin() {
  ...
  const onSubmit = async (data: { email: string; password: string }) => {
    try {
      ...
      (document.getElementById("modal_login") as HTMLDialogElement)?.close();
  ...
  return (
    <div className="modal-box w-full max-w-sm p-10">
      ...
      <h2 className="text-2xl font-bold text-base-content mb-2">Đăng nhập</h2>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        ...
        <div className="flex items-center justify-between mt-2">
          <label className="cursor-pointer label p-0 gap-2">
            ...
            />
            <span className="label-text text-base-content">Ghi nhớ tôi</span>
          </label>
          <a
            href="#"
      ...
      <p className="text-center text-base-content mt-8">
        ...
        <button
          ...
          onClick={() => {
            ...
            (
              document.getElementById("modal_register") as HTMLDialogElement
            )?.showModal();
          }}
        >
          Đăng ký ngay
